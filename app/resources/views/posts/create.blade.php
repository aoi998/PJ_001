    ...
    <div class="ms-3">
        <form action="{{ route('post.store') }}" method="POST">
            ...
            <div class="flex flex-col mb-3">
                ...
                <textarea id="body" name="body" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outlin"></textarea>
            </div>
            <div class="flex justify-center gap-3 mb-3">
                <button type="button" onclick="location.href='/posts'" class="bg-gray-500 text-white rounded-md px-4 py-2">戻る</button>
